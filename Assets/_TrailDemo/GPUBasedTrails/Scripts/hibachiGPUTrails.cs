...
{
    public class hibachiGPUTrails : MonoBehaviour
    {
        #region Type Define
        ...
        void Start()
        {
            ...
            trailNum = hibachiParticleBase.MaxObjectNum;
        ...
        public void LateUpdate_Trails()
        {
            ...
            // cs.SetBuffer(kernel, CSPARAM.INPUT_BUFFER, inputBuffer);
             cs.SetBuffer(kernel, CSPARAM.INPUT_BUFFER, hibachiParticleBase.boidDataBuffer);

            hibachiComputeShaderUtil.Dispatch(cs, kernel, new Vector3(trailNum, 1f, 1f));
        }
