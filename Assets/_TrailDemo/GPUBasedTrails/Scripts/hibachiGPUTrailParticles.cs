...
namespace BoidsSimulationOnGPU
{
    ...
    public class hibachiGPUTrailParticles : MonoBehaviour
    {
        ...
        protected hibachiGPUTrails trails;

        public hibachiGPUParticle hibachiParticleBase;
        ...
        void Start()
        {
            trails = GetComponent<hibachiGPUTrails>();
        ...
        // void Update()
        public void Update_TrailParticles()
        {
            ...
            // hibachiComputeShaderUtil.Dispatch(cs, kernelUpdate, updateThureadNum);


            // var kernelInput = cs.FindKernel(CSPARAM.WRITE_TO_INPUT);
            // cs.SetBuffer(kernelInput, CSPARAM.PARTICLE_BUFFER_READ, hibachiParticleBase.boidDataBuffer);
            // cs.SetBuffer(kernelInput, CSPARAM.INPUT_BUFFER, trails.inputBuffer);

            // var inputThreadNum = new Vector3(particleNum, 1f, 1f);
            // hibachiComputeShaderUtil.Dispatch(cs, kernelInput, inputThreadNum);
        }
